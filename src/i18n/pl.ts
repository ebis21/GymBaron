...
export const pl: Strings = {
  ...
  topbar: {
    ...
    cash: 'Kasa',
    members: 'Członkowie',
    payday: days => `wypłata za ${days} ${days === 1 ? 'dzień' : 'dni'}`,
    paydayToday: amount => `wypłata dziś +${amount}`,
    paydayTodayEmpty: 'wypłata dziś',
    gymClass: 'Klasa',
    reputation: 'Renoma',
    hours: '8:00 → 20:00',
    settings: 'Ustawienia',
  ...
  report: {
    ...
    passes: 'Nowe karnety',
    payday: (count, each) => `Wypłata z karnetów (${count} × ${each})`,
    paydayHint: days =>
      `Wypłata z karnetów za ${days} ${days === 1 ? 'dzień' : 'dni'} — wtedy płacą wszyscy członkowie naraz.`,
    total: 'Razem',
